...
def get_norm(norm, out_channels):
    ...
    if isinstance(norm, str):
        ...
        norm = {
            ...
            "SyncBN": NaiveSyncBatchNorm if torch.__version__ <= '1.5' else nn.SyncBatchNorm,
...
if __name__ == '__main__':
    get_norm('BN', 32)
    get_norm('SyncBN', 32)
    get_norm('FrozenBN', 32)
    get_norm('GN', 32)
    get_norm('nnSyncBN', 32)
    get_norm('naiveSyncBN', 32)
    get_norm('naiveSyncBN_N', 32)